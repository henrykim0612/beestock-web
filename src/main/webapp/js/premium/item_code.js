  ...
  function initGrid() {
    ...
    const props = {
      ...
      colModel: [
        ...
        {id: 'quantity', name: '보유수량', width: global.width.quantity, isSort: true, align: 'right', isCurrency: true, isExcel: true, hasTooltip: {col: 'itemName'}}, // TODO: 보유수량도 차트아이콘 보이게해서 차트 표시
