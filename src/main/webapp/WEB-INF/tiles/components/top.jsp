...
<nav class="is-fixed-top navbar is-black" role="navigation" aria-label="main navigation">
    ...
    <div id="topNav" class="navbar-menu">
        <div class="navbar-start">
            <a class="navbar-item" href="${pageContext.request.contextPath}/home/dashboard.do"><span class="icon has-text-warning mr-1"><i class="fas fa-home"></i></span>홈</a>
            <a class="navbar-item" href="${pageContext.request.contextPath}/home/documentation.do"><span class="icon has-text-warning mr-1"><i class="fas fa-book"></i></span>BeeStock 가이드</a>
            <%--구독자, 관리자 전용--%>
            ...
            <a class="navbar-item" href="${pageContext.request.contextPath}/home/pricing-table.do"><span class="icon has-text-warning mr-1"><i class="fas fa-book-reader"></i></span>구독</a>
            <%--관리자만 가능--%>
            <sec:authorize access="hasRole('ROLE_ADMIN')">
                <div class="navbar-item has-dropdown is-hoverable">
                    <a class="navbar-link"><span class="icon has-text-warning mr-1"><i class="fas fa-cogs"></i></span>시스템관리</a>
                    <div class="navbar-dropdown">
                        <a class="navbar-item" href="${pageContext.request.contextPath}/admin/user-management.do"><span class="icon has-text-primary mr-1"><i class="fas fa-cog"></i></span>사용자관리</a>
                        <a class="navbar-item" href="${pageContext.request.contextPath}/admin/code-management.do"><span class="icon has-text-primary mr-1"><i class="fas fa-cog"></i></span>시스템 코드관리</a>
