...
<div class="dashboard vh160">
    <!-- left panel -->
    <div class="dashboard-panel is-medium has-thick-padding has-background-grey-lighter is-hidden-mobile">
        <header class="dashboard-panel-header">
            <div class="has-text-centered">
                <figure class="image mb-3 is-2by1">
                    <img src="${pageContext.request.contextPath}/resources/images/logo.png" alt="No image">
                </figure>
            </div>
        </header>
    ...
    <div class="dashboard-main is-scrollable">
        ...
        <footer class="footer has-background-black has-text-white">
            ...
            <p>
                Notice that this entire space is filled up.
            </p>
        </footer>
    </div>
</div>
